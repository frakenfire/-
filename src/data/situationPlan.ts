...
export const STANCE_LEAD: Record<Stance, string> = {
  run: '지금 움직여도 되는 때예요.',
  prep: '곧 열리는 때라 지금은 준비하는 자리예요.',
  hold: '이번 달은 버거우니 지금 정하지 않는 쪽이 나아요.',
  keep: '어느 쪽으로도 안 기울어요. 새로 벌이기보다 하던 것을 이어갈 때예요.',
};
...
const SITUATION_PLAN: Record<ConcernKey, Record<string, Plan>> = {
  work: {
    ...
    start: {
      focus: '지원 수가 곧 확률이에요. 완벽한 서류 한 장보다 다섯 곳이 빨라요.',
      dos: [
      ...
      donts: [
        ...
        '완벽한 서류를 만든다고 지원을 미루기',
        '떨어진 곳의 이유를 안 물어보고 넘어가기',
      ],
    },
    own: {
      focus: '내 일은 버틸 개월 수가 곧 실력이에요. 나갈 돈부터 세고 시작하세요.',
      dos: [
        '개업에 들어갈 돈과 버틸 개월을 숫자로 적어보기',
        '첫 손님이 될 사람 다섯 명을 적어보기',
        '제일 작게 만들 수 있는 형태로 한 번 팔아보기',
      ],
      donts: [
        '숫자를 안 보고 판부터 키우기',
