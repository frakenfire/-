...
export const PLANS: Record<FortuneType, Record<MoodGroup, MoodPlan[]>> = {
  ...
  love: {
    ...
    flat: [
      ...
      {
        headline: '오늘은 사이를 한 뼘만 가깝게 해봐요.',
        vibe: '거창하게 해주는 것보다 사소하게 챙겨주는 게 통해요.',
        steps: [
    ...
    up: [
      ...
      },
      {
        ...
        steps: [
          ...
          { when: '저녁', text: '들은 의견 하나를 다음 계획에 넣어요.' },
        ],
  ...
  caution: {
    ...
    flat: [
      ...
      {
        headline: '오늘은 깜빡하는 것만 조심하면 무난해요.',
