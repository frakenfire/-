...
export const FORTUNE_TYPES: FortuneTypeMeta[] = [
  ...
  { key: 'love', label: '연애운', desc: '썸·연락·재회운', cta: '연애쪽지 받기', icon: 'heart' },
  { key: 'money', label: '금전운', desc: '수입·지출·재물운', cta: '금전운쪽지 받기', icon: 'coin' },
  { key: 'work', label: '직장운', desc: '직장·업무·기회', cta: '직장운쪽지 받기', icon: 'briefcase' },
