...
const EXCEPTIONS = new Map([
  ...
  // 쪽지 4색 — 뽑기 화면의 종이 색. 파스텔 4종이 서로 또렷이 구분돼야 '골랐다'는 감각이 산다.
  // TDS 50 단계는 서로 너무 비슷해 네 장이 전부 허옇게 뭉갠다.
  ['#e6f7ee', '쪽지 종이색(초록)'], ['#bfe6d2', '쪽지 종이색(초록) 테두리'],
  ['#fff3da', '쪽지 종이색(크림)'], ['#f4e0b0', '쪽지 종이색(크림) 테두리'],
  ['#fff0c2', '쪽지 종이색(노랑)'], ['#f3dd93', '쪽지 종이색(노랑) 테두리'],
  ['#ffe4ee', '쪽지 종이색(분홍)'], ['#f6c4d6', '쪽지 종이색(분홍) 테두리'],
